    ...
    <div className="md:mt-20 flex-1 max-w-7xl mx-auto pt-4 px-4 pb-16 md:pb-4">
      <div className={`flex flex-col h-[calc(100vh-120px)] rounded-lg shadow-lg overflow-hidden ${darkMode ? 'bg-gray-800 text-white' : 'bg-white'}`}>
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Contacts sidebar */}
          {showContacts && (
            <div className={`w-full md:w-80 border-r ${darkMode ? 'border-gray-700' : 'border-gray-200'} overflow-y-auto`}>
              <div className="p-4">
          ...
          {/* Chat area */}
          <div className={`flex-1 flex flex-col ${!showContacts || window.innerWidth >= 768 ? 'block' : 'hidden md:block'}`}>
            {activeChat ? (
              <>
                {/* Chat header */}
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className={`${darkMode ? 'text-gray-400' : 'text-gray-500'} mb-4`}>Select a chat to start messaging</p>
                </div>
              </div>
            )}
          </div>
