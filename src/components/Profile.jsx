...
export default function Profile({ darkMode }) {
  ...
  const [user] = useState({
    ...
    education: "Dinajpur University of Technology",
    phone: "01873488443",
    followers: 1250,
    following: 420
  })
    ...
    <div className={`mt-12 flex-1 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50'}`}>
      ...
      <div className="relative">
        ...
        <div className="absolute -bottom-16 left-4 sm:left-8">
          <img src={user.profilePicture} alt={user.name} className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-white shadow-md" />
        </div>
      </div>
